...
const DISCORD_CONFIG = {
  webhookUrl: process.env.DISCORD_WEBHOOK_URL_JNUKCC,
  threadId: process.env.DISCORD_THREAD_ID_JNUKCC
};

// ================= URLS =================
const urls = [
'https://uk.creativepulse23.com/recommendation-card',
'https://uk.zienic.com/options-recommendations'];
...
async function enviarDiscord() {
  let corpo = '🚨 FALHAS DE ANÚNCIO - JN UK CC\n\n';
