...
const DISCORD_CONFIG = {
  webhookUrl: process.env.DISCORD_WEBHOOK_URL_GRIDUSCC,
  threadId: process.env.DISCORD_THREAD_ID_GRIDUSCC
};

// ================= URLS =================
const urls = [
'https://dissemedisse.com/usa-card-recommendation-1',
'https://us.energiaradiante.com.br/us-credit-card-recommendation-1',
'https://dissemedisse.com/usa-card-recommendation-2' ];
...
async function enviarDiscord() {
  let corpo = '🚨 FALHAS DE ANÚNCIO - GRID US CC\n\n';
