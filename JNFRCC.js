...
const DISCORD_CONFIG = {
  webhookUrl: process.env.DISCORD_WEBHOOK_URL_JNFRCC,
  threadId: process.env.DISCORD_THREAD_ID_JNFRCC
};

// ================= URLS =================
const urls = [
'https://fr.meucartaoideal.com/card-france-1',
'https://fr.creativepulse23.com/fr-carte-de-credit-2'];
...
async function enviarDiscord() {
  let corpo = '🚨 FALHAS DE ANÚNCIO - JN FR CC\n\n';
