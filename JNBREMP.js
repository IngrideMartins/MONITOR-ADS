...
const DISCORD_CONFIG = {
  webhookUrl: process.env.DISCORD_WEBHOOK_URL_JNBREMP,
  threadId: process.env.DISCORD_THREAD_ID_JNBREMP
};

// ================= URLS =================
const urls = [
'https://emprestimo.meucartaoideal.com/pt-br-recomendacao-de-emprestimos-3',
'https://emprestimo.creativepulse23.com/recomendacao-de-emprestimos-2'];
...
async function enviarDiscord() {
  let corpo = '🚨 FALHAS DE ANÚNCIO - JN BR EMP\n\n';
