...
const DISCORD_CONFIG = {
  webhookUrl: process.env.DISCORD_WEBHOOK_URL_MGUSCC,
  threadId: process.env.DISCORD_THREAD_ID_MGUSCC
};

// ================= URLS =================
const urls = [
'https://us.widescope4.com/card-recommendation-2',
'https://us.cursosedu.com/recommendation-card',
'https://fincopilot.net/usa-card-recommendation-9',
'https://us.beneficioja.com.br/recommend-cards' ];
...
async function enviarDiscord() {
  let corpo = '🚨 FALHAS DE ANÚNCIO - MG US CC\n\n';
