...
const DISCORD_CONFIG = {
  webhookUrl: process.env.DISCORD_WEBHOOK_URL_JNBRDV360,
  threadId: process.env.DISCORD_THREAD_ID_JNBRDV360
};

// ================= URLS =================
const urls = [
'http://www.genialcredito.com/recomendacao-cartao'];
...
async function enviarDiscord() {
  let corpo = '🚨 FALHAS DE ANÚNCIO - JN BR DV360\n\n';
