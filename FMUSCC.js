...
const DISCORD_CONFIG = {
  webhookUrl: process.env.DISCORD_WEBHOOK_URL_FMFRCC,
  threadId: process.env.DISCORD_THREAD_ID_FMFRCC
};

// ================= URLS =================
const urls = [
'http://en.usmoney.com.br/usa-card-recommendation-5',
'https://finance.formoney.com.br/usa-card-recommendation-3' ];
...
async function enviarDiscord() {
  let corpo = '🚨 FALHAS DE ANÚNCIO - FM US CC\n\n';
