...
const DISCORD_CONFIG = {
  webhookUrl: process.env.DISCORD_WEBHOOK_URL_CL2USCC,
  threadId: process.env.DISCORD_THREAD_ID_CL2USCC
};

// ================= URLS =================
const urls = [
'https://credittus.com/capital-one-savor-rewards' ];
...
async function enviarDiscord() {
  let corpo = '🚨 FALHAS DE ANÚNCIO - CL2 US CC\n\n';
