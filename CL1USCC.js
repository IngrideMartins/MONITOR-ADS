...
const DISCORD_CONFIG = {
  webhookUrl: process.env.DISCORD_WEBHOOK_URL_CL1USCC,
  threadId: process.env.DISCORD_THREAD_ID_CL1USCC
};

// ================= URLS =================
const urls = [
'https://us.brcartao.com/us-card-recommendation-3',
'https://credittus.com/capital-one-savor-rewards/?utm_source=googleads&utm_medium=cl-principal'];
...
async function enviarDiscord() {
  let corpo = '🚨 FALHAS DE ANÚNCIO - CL1 US CC\n\n';
